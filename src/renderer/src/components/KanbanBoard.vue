    ...
    <div class="mb-6 flex flex-wrap items-center gap-3">
      ...
      <div class="group relative order-1 min-w-[16rem] flex-1">
        ...
        <input 
          ...
          class="w-full rounded-lg border border-slate-200 bg-white py-2 pl-10 pr-4 text-sm shadow-sm transition-all focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
        />
        <button 
          v-if="searchQuery" 
      ...
      <div class="relative order-2 shrink-0">
        ...
        <div v-if="showFilters" class="absolute left-0 mt-2 w-72 bg-white border border-slate-200 rounded-xl shadow-xl z-50 p-4">
          ...
          <div v-if="availableAssignees.length" class="mb-2">
            ...
            <div class="max-h-32 overflow-y-auto space-y-1 pr-1 scrollbar-app">
              <button 
